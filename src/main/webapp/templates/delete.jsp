...
<div class="container">
    <div class="modal">
        <p>
        <h2 class="str">Удалить блокнот номер: </h2>



        <form method="get" action="${pageContext.request.contextPath}/delete">
            <input type="text" class="requestInput" name="deleteNumber" placeholder="" value="1">
            <input type="submit" value="delete" class="requestButton">
        </form>


        <h2 class="str">Полная таблица</h2>
        </p>
