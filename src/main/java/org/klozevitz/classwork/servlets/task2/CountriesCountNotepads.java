...
@WebServlet("/countriesCountNotepads")
public class CountriesCountNotepads extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/templates/countriesCountNotepads.jsp");
